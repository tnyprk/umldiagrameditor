 ...
 *  @constructor
 *  @param size The size of the diamondNode
 *
 *  @returns A new DiamondNode object
 */
function createDiamondNode (size) {
  ...
  return {
     ...
     * @param The panel to draw the diamond node on.
     */
    draw(panel) {
     ...
     * @returns the specific type of this object 'DIAMONDNODE'
     */
    getSpecificType(){
      return "DIAMONDNODE"
    },
